...
__Query versions 2 and beyond are specifically designed for the trusted TEE key/value service as part of the trust model. BYOS servers do not need to implement these.__
